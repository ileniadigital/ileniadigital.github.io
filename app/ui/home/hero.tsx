            ...
            <main>
                ...
                <div className='flex flex-row'>
                    <div className='flex flex-col gap-5 mt-40 ml-20'>
                        ...
                        <button className='w-48 rounded-full bg-darkgreen p-3 text-white hover:text-yellow hover:font-bold hover:text-lg'><a href="/projects">See my projects</a></button>
                    </div>
