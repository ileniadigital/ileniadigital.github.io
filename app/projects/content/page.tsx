        ...
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex flex-col justify-center items-center flex-grow gap-32">
                ...
                <div className='flex flex-row gap-44 justify-center items-center'>
                    <Card title="Social Media" bg="coding" link="/content/socialmedia" />
                    <Card title="Fight For Peace" bg="content" link="/content/fightforpeace" />
                    <Card title="Byte Queens" bg="content" link="/content/bytequeens" />
                </div>
            </main>
