        ...
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex flex-col justify-center items-center flex-grow gap-32">
                ...
                <div className='flex flex-row gap-44 justify-center items-center'>
                    <Card title="Programming" bg="/images/projects/coding.jpg" link="/projects/programming" />
                    <Card title="Content Creation" bg="/images/projects/content.jpg" link="/projects/content" />
                </div>
            </main>
