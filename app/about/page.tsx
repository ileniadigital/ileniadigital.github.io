                    ...
                    <div className="ml-5 flex flex-row">
                        <div className='mt-10'>
                            ...
                            <p className="mt-3 text-xl">
                                I am originally from a small town in South Italy, I am a Computer Science Student at Queen Mary University of London, with a passion for development and design.
